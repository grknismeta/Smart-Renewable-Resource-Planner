...
# 1.A2: /interpolated-map endpoint (IDW heatmap noktaları) emekliye ayrıldı —
# tek görsel dil ilçe choropleth (`/weather/district-choropleth`).
# Caller temizlendi (frontend `report_service.fetchInterpolatedMap` da silindi).

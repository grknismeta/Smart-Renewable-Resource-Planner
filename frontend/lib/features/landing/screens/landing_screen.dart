...
class _LandingMapState extends State<_LandingMap> {
  ...
  void _waitForMapAndSetup() {
    Future.delayed(const Duration(milliseconds: 1500), () {
      ...
      MapViewMapLibre.setShowcasePins(_buildShowcaseGeoJson(isDark: isDark));
    });
  }

  /// Gerçekçi Türkiye YEK tesisleri — GeoJSON formatında.
  /// Güneş, Rüzgar ve HES tesisleri gerçek konumlara yakın yerleştirilir.
  static String _buildShowcaseGeoJson({bool isDark = true}) {
  ...
  static Map<String, dynamic> _pin(
    int id,
    String name,
    String type,
    double lat,
  ...
  static String _propsJson(Map<String, dynamic> p, {bool isDark = true}) {
